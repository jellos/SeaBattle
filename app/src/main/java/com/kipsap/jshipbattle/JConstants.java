...
public class JConstants {
    ...
    public static int getCountryFlagResourceID(String country)
    {
        ...
        if (country.equals("BS"))
            return R.drawable.land_bs;
        if (country.equals("BT"))
            return R.drawable.land_bt;
